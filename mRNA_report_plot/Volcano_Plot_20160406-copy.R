...
# out_dir <- cwd
#
test_data_path <- "/media/zxchen/3dddd6c4-2700-41a5-a677-15b165fa4e64/project/Analysis_project_backup/OM-mRNA-Medicago_truncatula-P20161206/test/test.volcano.plot.dat"
p = 0.05
lgfc = 1
cwd = getwd()
out_dir <- cwd
