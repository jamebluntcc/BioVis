...
edge_data <- fread("significant.correlation.txt")
node_data <- fread("wgcna.nodes.txt")
#for a test:
...
network_plot <- net_work(plotcord,m,net,node_data)
#find RPW8_data
...
ggsave(filename = "net_work_adj_100000.png",plot = network_plot,width = 8,height = 6)
ggsave(filename = "net_work_adj_100000.pdf",plot = network_plot,width = 8,height = 6)
